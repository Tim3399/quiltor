...
describe("Formatting as ranges", () => {
  ...
  it("takes bold away again when the spot is bold already", () => {
  ...
  it("carries marks along through text changes", () => {
  ...
  it("carries marks across a replacement made outside the editor", () => {
  ...
  it("cuts the text into sections of equal marking", () => {
  ...
  it("knows the book version's paragraphs and their position in the chapter", () => {
  ...
  it("writes Markdown markers on export, but never in the chapter text", () => {
