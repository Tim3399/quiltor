...
function open(props: Partial<React.ComponentProps<typeof ConfirmDialog>> = {}) {
  ...
  render(<LanguageProvider><ConfirmDialog title="Element löschen" description="„Ada“ wird entfernt." confirmLabel="Element löschen" onConfirm={onConfirm} onClose={onClose} {...props} /></LanguageProvider>);
