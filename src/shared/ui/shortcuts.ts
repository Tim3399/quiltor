...
export const IS_APPLE_OS = typeof navigator !== 'undefined'
...
// says "Strg", not "Ctrl".
export function shortcut(key: string, language: Language, modifiers: { shift?: boolean } = {}): string {
...
export function useShortcut() {
  ...
  return useCallback((key: string, modifiers?: { shift?: boolean }) => shortcut(key, language, modifiers), [language]);
}
