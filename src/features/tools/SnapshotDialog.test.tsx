...
vi.mock("../../lib/api", async (importOriginal) => {
  ...
  return {
    ...
    api: {
      ...
      backupLoginStatus: () => backupLoginStatus(),
      backupLoginBegin: () => backupLoginBegin(),
      backupLogout: () => backupLogout(),
      saveSnapshot: (message: string, upload: boolean) => saveSnapshot(message, upload),
    },
  };
});
