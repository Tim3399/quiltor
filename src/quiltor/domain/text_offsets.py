"""Runtime-neutral UTF-16 text-offset semantics.

CodeMirror and JavaScript index strings in UTF-16 code units. Persisted text
ranges use that same unit so an editor range has one meaning in every runtime.
Offsets inside a surrogate pair are invalid Unicode-scalar boundaries.
"""
