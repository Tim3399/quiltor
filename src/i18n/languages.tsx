...
export const languages = {
  de: {
    ...
    lightDesign: 'Helles Design', darkDesign: 'Dunkles Design', enableLight: 'Helles Design aktivieren', enableDark: 'Dunkles Design aktivieren',
    ...
    existingWorlds: 'Bestehende Welten', newWorld: 'Neue Welt', noWorld: 'Noch keine Welt vorhanden.', lastChanged: 'Zuletzt geändert',
    newWorldIntro: 'Beginne mit einem leeren Manuskript und einem freien Figurenboard.', worldTitle: 'Titel der Welt oder des Buches', worldExample: 'Zum Beispiel: Der letzte Garten', githubRepository: 'GitHub-Repository', githubExample: 'https://github.com/name/meine-welt', repositoryRequired: 'Jede Welt wird in ihrem eigenen privaten oder öffentlichen Repository gesichert.', createWorld: 'Welt erstellen',
    ...
    figuresWorld: 'Figuren & Welt', elements: 'Elemente', connections: 'Verbindungen', figure: 'Figur', place: 'Ort', concept: 'Konzept', connect: 'Verbinden', profiles: 'Steckbriefe', import: 'Import',
  ...
  en: {
    ...
    lightDesign: 'Light', darkDesign: 'Dark', enableLight: 'Enable light design', enableDark: 'Enable dark design',
    ...
    existingWorlds: 'Existing worlds', newWorld: 'New world', noWorld: 'No worlds yet.', lastChanged: 'Last changed',
    newWorldIntro: 'Start with an empty manuscript and a blank character board.', worldTitle: 'World or book title', worldExample: 'For example: The Last Garden', githubRepository: 'GitHub repository', githubExample: 'https://github.com/name/my-world', repositoryRequired: 'Each world is backed up to its own private or public repository.', createWorld: 'Create world',
    ...
    figuresWorld: 'Characters & world', elements: 'elements', connections: 'connections', figure: 'Character', place: 'Place', concept: 'Concept', connect: 'Connect', profiles: 'Profiles', import: 'Import',
