...
export const figures = {
  ...
  customFields: 'Eigene Felder', fieldName: 'Feldname', content: 'Inhalt', lineStyle: 'Linienstil', normal: 'Normal', dashed: 'Gestrichelt', bloodline: 'Blutlinie', deleteConnection: 'Beziehung löschen',
