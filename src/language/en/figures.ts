...
export const figures = {
  ...
  customFields: 'Custom fields', fieldName: 'Field name', content: 'Content', lineStyle: 'Line style', normal: 'Normal', dashed: 'Dashed', bloodline: 'Bloodline', deleteConnection: 'Delete relationship',
