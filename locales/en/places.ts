export const places = {
  ...
  placeShowAsPin: "Show place {name} as a pin",
  placeShowAsCard: "Show place {name} as a card",
  mapKind: "Map",
  placeViewMenu: "View",
  bindToMap: "Hold the view to the map",
  unbindFromMap: "Let the view leave the map",
  hideMapPictures: "Hide map pictures",
  showMapPictures: "Show map pictures",
  placeMapScale: "Scale of {name}",
  placeMapSection: "Map",
  ...
  placeMapOnePlace: "1 place",
  placeMapPlaceCount: "{n} places",
  placeMapGrid: "Grid",
  placeMapGridOff: "Off",
  placeMapGridUnits: "{n} px",
  placeMapPlaces: "Places",
  placeMapLevel: "Level",
  placeMapNoScale: "Set scale",
  placeMapScaleBar: "Scale bar: {distance}",
