export const places = {
  ...
  placeShowAsPin: "Ort {name} als Stecknadel anzeigen",
  placeShowAsCard: "Ort {name} als Karte anzeigen",
  mapKind: "Karte",
  placeViewMenu: "Ansicht",
  bindToMap: "An die Karte binden",
  unbindFromMap: "Von der Karte lösen",
  hideMapPictures: "Kartenbilder ausblenden",
  showMapPictures: "Kartenbilder einblenden",
  placeMapScale: "Maßstab von {name}",
  ...
  placeMapOnePlace: "1 Ort",
  placeMapPlaceCount: "{n} Orte",
  placeMapGrid: "Raster",
  placeMapGridOff: "Aus",
  placeMapGridUnits: "{n} px",
  placeMapPlaces: "Orte",
  placeMapLevel: "Ebene",
  placeMapNoScale: "Maßstab setzen",
  placeMapScaleBar: "Maßstabsleiste: {distance}",
